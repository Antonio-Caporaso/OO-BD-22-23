...
public class VisualizzaSessioniConferenza implements Initializable {
    ...
    private void loadAggiungiSponsor() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("../View/FXML/AddSponsor.fxml"));
    ...
    private void loadInserisciSessione() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("../View/FXML/InserisciSessione.fxml"));
    ...
    private void loadViewProgramma() {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("../View/FXML/ViewProgrammaSessione.fxml"));

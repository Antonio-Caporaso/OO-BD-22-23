...
public class ModificaSessioniController implements Initializable {
    ...
    public void addSessioneOnAction(ActionEvent event) throws IOException {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("../View/FXML/AddSessione.fxml"));
    ...
    public void editSessionsOnAction(ActionEvent event) throws IOException {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("../View/FXML/ModificaSessione.fxml"));

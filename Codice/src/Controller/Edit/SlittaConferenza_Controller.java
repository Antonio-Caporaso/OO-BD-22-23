...
public class SlittaConferenza_Controller implements Initializable {
    @FXML
    ...
    public SlittaConferenza_Controller(Conferenza conferenza, ModificaConferenza_Controller modificaConferenzaController) {
    ...
    public void setModificaConferenzaController(ModificaConferenza_Controller modificaConferenzaController) {
        this.modificaConferenzaController = modificaConferenzaController;
    }
